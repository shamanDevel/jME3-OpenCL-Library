...
__kernel void AddSimpleBuoyancy3D(FlagGrid_t flags, RealGrid_t factor, MACGrid_t vel, float4 strength, int sizeX, int sizeY, int sizeZ)
{
	...
	if (FlagGrid_get(flags, pos-(int3)(0,0,1), dim) == CellType_Fluid) {
